        ...
        <div className="bg-[#FCFCFC3B] border-2 border-white backdrop-blur-md rounded-lg p-6 md:p-8 w-full max-w-md mx-auto">
          ...
          <div>
            ...
            <div className="text-center mb-4 md:mb-6 text-sm md:text-base text-white">
              <p>
                If you haven’t received your verification code, please check
                your spam or junk folder before requesting a new one. 
                <span
                  className="text-accent-foreground font-bold cursor-pointer hover:underline"
